...
public class ReportConfigUtil {
	...
	private static void setCompileTempDir(ServletContext context, String uri) {
		System.setProperty("temp", context.getRealPath(uri));
	}
	...
	public static boolean compileReport(ServletContext context, String compileDir, String nameReport) throws JRException {

		String jasperFileName = context.getRealPath(compileDir + nameReport +".jasper");
